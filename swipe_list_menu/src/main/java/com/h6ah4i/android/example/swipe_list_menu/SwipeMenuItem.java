 ...
 */
package com.h6ah4i.android.example.swipe_list_menu;
...
public class SwipeMenuItem {
    ...
    public SwipeMenuItem setTopMargin(int topMargin) {
    ...
    public SwipeMenuItem setBottomMargin(int bottomMargin) {
    ...
    public SwipeMenuItem setLeftMargin(int leftMargin) {
    ...
    public SwipeMenuItem setRightMargin(int rightMargin) {
        this.rightMargin = rightMargin;
        return this;
    }

    public SwipeMenuItem setVerticalMargin(int horizontalMargin) {
        this.topMargin = horizontalMargin;
        this.bottomMargin = horizontalMargin;
        return this;
    }

    public SwipeMenuItem setHorizontalMargin(int verticalMargin) {
        this.leftMargin = verticalMargin;
        this.rightMargin = verticalMargin;
        return this;
